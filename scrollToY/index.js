...
/**
 * @type {import('./index.d.ts').scrollToY}
...
export function scrollToY(scrollTargetY, speed, easing) {
	...
	const requestAnimationFrame = (()=>window.requestAnimationFrame || window.webkitRequestAnimationFrame || // @ts-ignore
	...
	const time = max(0.1, min(abs(scrollY - scrollTargetY) / speed, 0.8))
